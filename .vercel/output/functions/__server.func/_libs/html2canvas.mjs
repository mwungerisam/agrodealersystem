...
var init_html2canvas_esm = __esmMin((() => {
	...
	parseDocumentSize = function(document) {
	...
	lookup$2 = typeof Uint8Array === "undefined" ? [] : /* @__PURE__ */ new Uint8Array(256);
	...
	lookup$1$1 = typeof Uint8Array === "undefined" ? [] : /* @__PURE__ */ new Uint8Array(256);
	...
	UTRIE2_DATA_MASK$1 = (1 << UTRIE2_SHIFT_2$1) - 1;
	UTRIE2_INDEX_1_OFFSET$1 = UTRIE2_LSCP_INDEX_2_OFFSET$1 + (1024 >> UTRIE2_SHIFT_2$1) + 32;
	UTRIE2_OMITTED_BMP_INDEX_1_LENGTH$1 = 65536 >> UTRIE2_SHIFT_1$1;
	UTRIE2_INDEX_2_MASK$1 = (1 << UTRIE2_SHIFT_1_2$1) - 1;
	...
	createTrieFromBase64$1 = function(base64, _byteLength) {
	...
	lookup$3 = typeof Uint8Array === "undefined" ? [] : /* @__PURE__ */ new Uint8Array(256);
	...
	isAdjacentWithSpaceIgnored = function(a, b, currentIndex, classTypes) {
	...
	lookup$1 = typeof Uint8Array === "undefined" ? [] : /* @__PURE__ */ new Uint8Array(256);
	...
	UTRIE2_DATA_MASK = (1 << UTRIE2_SHIFT_2) - 1;
	UTRIE2_INDEX_1_OFFSET = UTRIE2_LSCP_INDEX_2_OFFSET + (1024 >> UTRIE2_SHIFT_2) + 32;
	UTRIE2_OMITTED_BMP_INDEX_1_LENGTH = 65536 >> UTRIE2_SHIFT_1;
	UTRIE2_INDEX_2_MASK = (1 << UTRIE2_SHIFT_1_2) - 1;
	...
	createTrieFromBase64 = function(base64, _byteLength) {
	...
	lookup = typeof Uint8Array === "undefined" ? [] : /* @__PURE__ */ new Uint8Array(256);
	...
	testIOSLineBreak = function(document) {
		var testElement = document.createElement("boundtest");
	...
	testForeignObject = function(document) {
		var canvas = document.createElement("canvas");
		var size = 100;
		canvas.width = size;
		canvas.height = size;
	...
	getCurvePoints = function(x, y, r1, r2, position) {
	...
	calculateBackgroundPositioningArea = function(backgroundOrigin, element) {
		if (backgroundOrigin === 0) return element.bounds;
		if (backgroundOrigin === 2) return contentBox(element);
		return paddingBox(element);
	};
	calculateBackgroundPaintingArea = function(backgroundClip, element) {
...
//#endregion
export { init_html2canvas_esm as n, html2canvas_esm_exports as t };
